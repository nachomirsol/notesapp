...
import DoneItem from "./components/DoneItem/DoneItem";
          ...
          <div className="columns">
            <div className="column is-4">
              <section className="section">
                ...
                <h3 className="subtitle">Rellena los datos</h3>
            ...
            <div className="column is-4">
              <section className="section">
                ...
                <h2 className="subtitle">Notas Pendientes</h2>
            ...
            <div className="column is-4">
              <section className="section">
                <h1 className="title">Notas</h1>
                <h2 className="subtitle">Atendidas</h2>
